  ...
  return (
    <div className={` border border-red-500 h-screen md:w-8/12 m-auto flex items-center text-gray-500`}>
      ...
      <div className={` border-blue-500 pl-3 pr-5 sm:basis-1/3`}>
        ...
        <div className={`border-l border-green-500  py-1 px-2 fontKeySm`}>Scout</div>
        <div className={`border-l border-green-500  py-1 px-2 fontKeySm`}>Starry</div>
      ...
      <div className={` border-blue-500 mt-6 sm:mt-0 sm:basis-2/3`}>
        ...
        <div><FontAwesomeIcon icon={faCaretRight} style={{"color":"green"}}/></div>
              <p className={` mx-2`}>Write modern, performant,
          maintainable code for a diverse array of client and internal projects</p>
            </div>

            <div className={` border-red-500 flex font-medium pt-2 textSm`}>
            <div><FontAwesomeIcon icon={faCaretRight} style={{"color":"green"}}/></div>
              <p className={` mx-2`}>Work with a variety of different languages, platforms, frameworks, and
          ...
          React, Craft, WordPress, Prismic, and Netlify</p>
            ...
            <div className={` border-red-500 flex font-medium pt-2 textSm`}>
            <div><FontAwesomeIcon icon={faCaretRight} style={{"color":"green"}}/></div>
              <p className={` mx-2`}>Communicate with
