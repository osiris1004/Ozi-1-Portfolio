...
export const Contact = () => {
    return (
        <div className={`border-red-500  py-10 w-8/12 m-auto`}>
            <div className={`flex flex-wrap sm:flex-nowrap justify-center`}>
                <div className={`px-10 pt-5 text-gray-500  sm:basis-1/2 p-3 `}>
                ...
                <div className={'border border-yellow-100  sm:basis-1/2 p-3 bg-gray-500'}>
                <img
            alt={"profile"}
            src={
