...
import { SET_DAY_SELECTED, SET_DELETE_EVENT_DATA, SET_SAVE_EVENT_DATA, SET_SELECTED_EVENT } from "./globalRedux/Type"
...
export const store = configureStore({
  ...
  middleware : (getDefaultMiddleware) => getDefaultMiddleware({
    serializableCheck :{
      ignoredActions: [SET_DAY_SELECTED, SET_SAVE_EVENT_DATA,SET_SELECTED_EVENT, SET_DELETE_EVENT_DATA ],
